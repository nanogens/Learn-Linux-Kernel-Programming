...
static unsigned int PID = 1; // this is the default PID it looks for if none in specified in the param.  This is how to specify  (i.e. sudo insmod tasks.ko PID=60)
